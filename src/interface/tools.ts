...
export const moxieMcpTools: McpTool[] = [
  ...
  },
  {
    ...
    annotations: readOnlyAnnotations("Get API endpoint context"),
  },
  {
    name: "moxie.review_change",
    description:
    ...
    annotations: readOnlyAnnotations("Review a change before the PR"),
  },
  {
